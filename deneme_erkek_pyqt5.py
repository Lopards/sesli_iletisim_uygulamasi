...
from deneme_erkek import Ui_Server_erkek
...
class deneme(QWidget):
    def __init__(self) -> None:
        super().__init__()
        self.server_erkek = Ui_Server_erkek()
    ...
    def hoparlor_gonder(self):
         #deneme amaçlıdır bu fonksiyonu sileceksin.
        self.hoparlor_liste()

        hoparlor_listesi_str = pickle.dumps(self.output_device_list)
        self.client_socket.send(hoparlor_listesi_str)
